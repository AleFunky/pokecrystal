...
DarkCaveBlackthornEntrance_MapEvents:
	...
	object_event  7, 22, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, DarkCaveBlackthornEntranceAwakening, EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_TM_SNORE
